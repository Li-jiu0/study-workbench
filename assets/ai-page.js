...
(function () {
  ...
  var RATE_FALLBACK = {
    ...
    'gm-flash': '1.2x',
    'ark-seedream-5-0': '1x',
    'ark-seedream-5-0-pro': '1x',
    'ark-seedance-1-0-pro': '1x',
    'ark-seedance-1-0-pro-fast': '1x',
    'ark-hyper3d-gen2': '1x',
    'ark-seed-2-1-pro-260628': '1x',
    'ark-seed-2-0-pro': '1x',
    'ark-smart-router': '1x',
  ...
  var MODEL_DETAILS = {
    ...
    'ark-seedream-5-0': { platform: "火山方舟·图片生成", params: "", type: "图片生成（最新）", stars: '★★★★★', speed: "快", advantage: "Seedream 5.0 文生图，画质与指令跟随较 4.x 全面提升；走 images/generations 接口，实测 1024x1024 直连出图正常", applicable: "文生图（首选）" },
    ...
    'ark-seedream-5-0-pro': { platform: "火山方舟·图片生成", params: "", type: "图片生成（Pro）", stars: '★★★★★', speed: "中", advantage: "Seedream 5.0 Pro 文生图，复杂提示词与画质更强；走 images/generations 接口，实测直连 HTTP 200 出图", applicable: "文生图（质量优先）" },
    'ark-seedance-1-0-pro': { platform: "火山方舟", params: "", type: "视频生成", stars: '★★★★★', speed: "慢", advantage: "文生视频 / 图生视频；输入文字提示词（图生视频再传一张首帧图），输出 5～10 秒 MP4；分钟级异步返回；单次消耗约 10 万 tokens 量级", applicable: "文生视频、图生视频" },
    'ark-seedance-1-0-pro-fast': { platform: "火山方舟", params: "", type: "视频生成（快速版）", stars: '★★★★', speed: "慢", advantage: "文生视频 / 图生视频快速版，输入与输出同标准版，出片更快；分钟级异步返回", applicable: "文生视频、图生视频（速度优先）" },
    'ark-hyper3d-gen2': { platform: "火山方舟", params: "", type: "3D 生成", stars: '★★★★', speed: "慢", advantage: "图生 3D；输入一张图片，输出 3D 模型文件；分钟级异步返回；单次消耗约 3 万 tokens 量级", applicable: "图生 3D 模型" },
    'ark-seed-2-1-pro-260628': { platform: "火山方舟", params: "", type: "通用对话（新版）", stars: '★★★★★', speed: "中", advantage: "Doubao-Seed-2.1-pro 的 260628 版本；额度每天 200 万 token", applicable: "复杂问答、长链思考" },
    'ark-seed-2-0-pro': { platform: "火山方舟", params: "", type: "通用对话", stars: '★★★★', speed: "中", advantage: "Doubao-Seed-2.0-pro；额度每天 200 万 token", applicable: "日常问答、文案创作" },
    'ark-smart-router': { platform: "火山方舟", params: "", type: "自动路由", stars: '★★★★', speed: "快", advantage: "方舟智能路由模型，自动选择合适模型作答", applicable: "不想挑模型时的日常问答" },
  ...
  var FALLBACK_MODELS = [
    ...
    { id: 'ark-seedream-5-0', name: 'Seedream-5.0', provider: 'arkimage', model: 'doubao-seedream-5-0-260128', types: ['imagegen'], tag: '免费', rate: '1x', fallback: null },
    { id: 'ark-seedream-5-0-pro', name: 'Seedream-5.0-Pro', provider: 'arkimage', model: 'doubao-seedream-5-0-pro-260628', types: ['imagegen'], tag: '免费', rate: '1x', fallback: null },
    { id: 'ark-seedance-1-0-pro', name: 'Doubao-Seedance-1.0-pro', provider: 'ark', model: 'doubao-seedance-1-0-pro-250528', types: ['video'], audio: true, tag: '免费', rate: '1x', fallback: 'ark-seedance-1-0-pro-fast' },
    { id: 'ark-seedance-1-0-pro-fast', name: 'Doubao-Seedance-1.0-pro-fast', provider: 'ark', model: 'doubao-seedance-1-0-pro-fast-251015', types: ['video'], audio: true, tag: '免费', rate: '1x', fallback: 'ark-seedance-1-0-pro' },
    { id: 'ark-hyper3d-gen2', name: 'Hyper3D-Gen2', provider: 'ark', model: 'hyper3d-gen2-260112', types: ['3d'], tag: '免费', rate: '1x', fallback: 'ark-seed3d-2-0' },
    { id: 'ark-seed-2-1-pro-260628', name: 'Doubao-Seed-2.1-pro（260628）', provider: 'ark', model: 'doubao-seed-2-1-pro-260628', types: ['general'], tag: '免费', rate: '1x', fallback: 'ark-doubao-pro' },
    { id: 'ark-seed-2-0-pro', name: 'Doubao-Seed-2.0-pro', provider: 'ark', model: 'doubao-seed-2-0-pro-260215', types: ['general'], tag: '免费', rate: '1x', fallback: 'ark-doubao-pro' },
    { id: 'ark-smart-router', name: 'Doubao-Smart-Router', provider: 'ark', model: 'doubao-smart-router-250928', types: ['general'], tag: '免费', rate: '1x', fallback: 'ark-v4-flash' },
  ...
  /* ---------- R11d：额度耗尽自动隐藏 ----------
     数据源：GET /api/ai/usage（服务端全局账本，账号级共享）。
     语义：仅当某模型明确 exhausted === true 时才隐藏；数据缺失 / 请求失败 /
     游客脱敏（服务端只回 models:{}）一律不隐藏（fail-open，绝不误伤）。
     与 disabled / health / 分类筛选叠加 = 交集，只在渲染期过滤，可逆。 */
  var QUOTA_SNAP_TTL = 60000;
  var quotaSnap = { models: null, at: 0, inflight: false };
  ...
  function isHiddenByQuota(id) {
    if (!id) return false;
    var m = quotaSnap.models;
    if (!m || typeof m !== 'object') return false;
    var rec = m[id];
    if (!rec || typeof rec !== 'object') return false;
    return rec.exhausted === true;
  }
  /* cb 只在【真正拿到新快照】时回调一次；TTL 命中 / 请求进行中都不回调，
     避免「渲染 -> 拉取 -> 回调再渲染」形成循环。 */
  function refreshQuotaSnap(cb) {
    var now = Date.now();
    if (quotaSnap.models && (now - quotaSnap.at) < QUOTA_SNAP_TTL) return;
    if (quotaSnap.inflight) return;
    quotaSnap.inflight = true;
    var done = function (changed) {
      quotaSnap.inflight = false;
      if (changed && typeof cb === 'function') { try { cb(); } catch (e) { /* ignore */ } }
    };
    try {
      fetch(quotaApiBase() + '/api/ai/usage', { method: 'GET' })
        .then(function (r) { return (r && typeof r.json === 'function') ? r.json() : null; })
        .then(function (j) {
          var changed = false;
          if (j && j.models && typeof j.models === 'object') {
            quotaSnap.models = j.models;
            quotaSnap.at = Date.now();
            changed = true;
          }
          done(changed);
        }, function () { done(false); });
  ...
  function applyListSettings(list) {
    ...
    for (i = 0; i < list.length; i++) {
      if (!isDisabledId(list[i].id) && !isHiddenByHealth(list[i].id) && !isHiddenByCategory(list[i].id) && !isHiddenByQuota(list[i].id)) out.push(list[i]);
    }
  ...
  function openModelPanel() {
    ...
    refreshQuotaSnap(renderModelList);   // R11d：打开面板时刷新额度快照（TTL/inflight 去抖，拿到新快照再重渲染）
  ...
  function init() {
    ...
    doc.addEventListener('visibilitychange', function () {
      if (doc.visibilityState === 'hidden') releaseMicAll();
    });
    ...
    // R11d：初始化区拉一次额度快照（本 IIFE 无 renderModelList() 显式初始化调用点，故在此引导）；
    // 额度耗尽（exhausted === true）的模型在渲染期自动隐藏。
    refreshQuotaSnap(renderModelList);
  }
