...
// ========== 数据存储 ==========
const STORAGE_KEY = 'study_workbench_data';
let appData = {
  countdowns: [],
  tasks: [
...
const EXAM_BANK = [
  // ===== 图形推理（10题） =====
  { id: 1, type: '图形推理', sub: '位置类', diff: 2, q: '从所给的四个选项中，选择最合适的一个填入问号处，使之呈现一定的规律性：图形中小黑点依次在左上、右上、右下、左下位置。', options: ['左上','右上','左下','右下'], answer: 0, exp: '小黑点沿顺时针方向依次移动：左上→右上→右下→左下→（回到左上）。第5个图应回到左上位置。', tip: '看到元素位置变化，先画移动路径，判断顺时针还是逆时针。' },
  { id: 2, type: '图形推理', sub: '位置类', diff: 2, q: '题干图形中，箭头每次逆时针旋转45度，问第5个图箭头指向哪个方向？', options: ['向上','向下','向左','向右'], answer: 1, exp: '箭头逆时针旋转：上→左→下→右→（下）。第5个图箭头向下。', tip: '旋转题要注意方向（顺/逆）和角度，逐次画出来不容易错。' },
  { id: 3, type: '图形推理', sub: '样式类', diff: 3, q: '从所给的四个选项中，选择最合适的一个填入问号处：第一组图1和图2去同存异得到图3，第二组同理。', options: ['A图形','B图形','C图形','D图形'], answer: 1, exp: '去同存异规律：两个图形叠加，去掉相同部分，保留不同部分。第二组图1和图2去同存异得到B。', tip: '样式运算常考：去同存异、去异存同、叠加、黑白运算。' },
  { id: 4, type: '图形推理', sub: '数量类', diff: 3, q: '题干图形中封闭区域数量依次为：1、2、3、4、？，问问号处图形封闭区域数为多少？', options: ['4','5','6','7'], answer: 1, exp: '封闭区域数呈等差数列递增：1→2→3→4→（5）。问号处应有5个封闭区域。', tip: '数量类考点：点、线、角、面、素。封闭区域属于"面"的数量。' },
  { id: 5, type: '图形推理', sub: '数量类', diff: 2, q: '题干图形中直线数量依次为：3、4、5、6、？，问问号处图形直线数为多少？', options: ['6','7','8','9'], answer: 1, exp: '直线数呈等差数列递增：3→4→5→6→（7）。问号处应有7条直线。', tip: '数线时注意：只数直线还是直线曲线都数，看题干规律。' },
  { id: 6, type: '图形推理', sub: '属性类', diff: 2, q: '题干图形均为轴对称图形，且对称轴数量依次为1、2、3、4、？，问问号处对称轴数量？', options: ['4','5','6','7'], answer: 1, exp: '对称轴数量递增：1→2→3→4→（5）。问号处应有5条对称轴。', tip: '属性类考点：对称性、曲直性、开闭性。轴对称要数对称轴数量和方向。' },
  { id: 7, type: '图形推理', sub: '空间重构', diff: 4, q: '左边给定的是正方体的外表面展开图，右边哪一项能由它折叠而成？（相对面不相邻原则）', options: ['A项','B项','C项','D项'], answer: 2, exp: '空间重构题用相对面法：展开图中相对的面在立体图中不能相邻。A、B、D中均有相对面相邻的错误，C正确。', tip: '空间重构先找相对面（相间、Z端），相对面不相邻直接排除。' },
  { id: 8, type: '图形推理', sub: '位置类', diff: 3, q: '题干中两个元素，一个顺时针移动1格，另一个逆时针移动2格，问第5个图中两元素位置关系？', options: ['相邻','相对','重合','分离'], answer: 2, exp: '元素A顺时针：位置1→2→3→4→5；元素B逆时针：位置1→6→5→4→3。第5个图两元素在位置5和3，不重合。重新计算后两元素在第5步重合。', tip: '多元素移动题要分别追踪每个元素的轨迹，最后再看关系。' },
  { id: 9, type: '图形推理', sub: '样式类', diff: 3, q: '题干图形黑白运算规律：黑+黑=白，白+白=白，黑+白=黑，白+黑=黑。问图1和图2运算结果？', options: ['A','B','C','D'], answer: 1, exp: '按黑白运算规则逐格计算：黑+黑=白，白+白=白，黑+白=黑。运算结果为B。', tip: '黑白运算题先从已知图形中提炼运算规则，再逐格套用。' },
  { id: 10, type: '图形推理', sub: '数量类', diff: 3, q: '题干图形中交点数量依次为：2、4、6、8、？，问问号处图形交点数？', options: ['8','10','12','14'], answer: 1, exp: '交点数呈等差数列递增：2→4→6→8→（10）。问号处应有10个交点。', tip: '交点包括：直线与直线、直线与曲线、曲线与曲线的交点，看题干统一数哪种。' },
  // ===== 定义判断（5题） =====
  { id: 11, type: '定义判断', sub: '单定义', diff: 2, q: '沉没成本是指已经付出且不可收回的成本。根据上述定义，下列属于沉没成本的是：', options: ['小李买了电影票，看了一半觉得不好看，还是坚持看完','小王买了新手机，用了一周后觉得不好用，转手卖掉','小张花200元办了健身卡，去了一次就再也没去','小赵预订了酒店，因行程变更提前取消，全额退款'], answer: 2, exp: '沉没成本的关键是"已经付出且不可收回"。A电影票钱已付但坚持看完不是成本本身；B卖手机收回部分成本；C健身卡200元已付且无法收回，符合定义；D全额退款说明可收回。', tip: '定义判断抓关键词：主体、客体、条件、结果，逐项比对选项。' },
  { id: 12, type: '定义判断', sub: '单定义', diff: 2, q: '逆向思维是指对司空见惯的似乎已成定论的事物或观点反过来思考的一种思维方式。下列不属于逆向思维的是：', options: ['别人都往拥挤的方向走，我反其道而行之','司马光砸缸，让水离开人而不是让人离开水','别人恐慌我贪婪，别人贪婪我恐慌','按照老师教的方法一步步解题'], answer: 3, exp: '逆向思维的关键是"反过来思考"。A反方向走、B砸缸（常规是救人，他是放水）、C反市场情绪，都是逆向思维。D按常规方法解题，不属于逆向思维。', tip: '注意题目问"不属于"，不要看错。定义判断要找与定义关键信息不符的选项。' },
  { id: 13, type: '定义判断', sub: '单定义', diff: 3, q: '晕轮效应是指在人际交往中，人们常从对方的某个特性出发，泛化到其他方面，从而产生以偏概全的印象。下列属于晕轮效应的是：', options: ['小王觉得长得好看的人，性格也一定很好','小李因为一次考试没考好，就觉得自己很笨','小张因为朋友一次迟到，就认为对方总是不守时','小赵觉得北方人都豪爽，南方人都细腻'], answer: 0, exp: '晕轮效应的关键是"从某个特性泛化到其他方面，以偏概全"。A从"长得好看"泛化到"性格好"，符合晕轮效应。B是自我否定，C是过度概括但不是特性泛化，D是刻板印象。', tip: '晕轮效应（光环效应）：一好百好，一坏百坏。注意和刻板印象、首因效应区分。' },
  { id: 14, type: '定义判断', sub: '多定义', diff: 3, q: '正强化是指给予一个愉快刺激，从而增强其行为出现的概率。负强化是指撤销一个厌恶刺激，从而增强其行为出现的概率。下列属于负强化的是：', options: ['小明考试考了100分，妈妈奖励他一个玩具','小红按时完成作业，妈妈就不让她做家务了','小刚上课说话，老师批评了他','小丽考试不及格，爸爸没收了她的手机'], answer: 1, exp: '负强化的关键是"撤销厌恶刺激，增强行为概率"。A给予愉快刺激（玩具）是正强化；B撤销厌恶刺激（做家务），增强按时完成作业的行为，是负强化；C给予厌恶刺激（批评）是正惩罚；D撤销愉快刺激（手机）是负惩罚。', tip: '强化都是为了增加行为概率，惩罚是为了减少。正=给予，负=撤销。正强化=给好的，负强化=撤坏的。' },
  { id: 15, type: '定义判断', sub: '单定义', diff: 2, q: '长尾效应是指那些原来不受到重视的、销量小但种类多的产品或服务，由于总量巨大，累积起来的总收益超过主流产品的现象。下列属于长尾效应的是：', options: ['某书店畅销书占总销量的80%','某电商平台小众商品种类繁多，总销售额超过了爆款商品','某电影票房集中在几部大片上','某超市只卖最受欢迎的100种商品'], answer: 1, exp: '长尾效应的关键是"小众产品总量巨大，总收益超过主流产品"。A畅销书占主流，不是长尾；B小众商品总销售额超爆款，符合定义；C票房集中在大片，不是长尾；D只卖主流商品，没有长尾。', tip: '长尾效应的核心是"小众但量大"，互联网时代由于货架成本低，小众商品也能创造大收益。' },
  // ===== 类比推理（5题） =====
  { id: 16, type: '类比推理', sub: '逻辑关系', diff: 1, q: '医生：医院  相当于  教师：？', options: ['教室','学校','学生','课本'], answer: 1, exp: '医生在医院工作，是职业与工作场所的对应关系。教师在学校工作，所以选学校。教室是教师工作的具体场所，但医院是机构，学校也是机构，对应更准确。', tip: '类比推理先判断词项关系（职业-场所、因果、并列、包含等），再找最匹配的选项。注意二级辨析：具体场所vs机构。' },
  { id: 17, type: '类比推理', sub: '逻辑关系', diff: 2, q: '苹果：水果  相当于  ：？', options: ['鲸鱼：鱼类','蝙蝠：鸟类','老虎：哺乳动物','企鹅：两栖动物'], answer: 2, exp: '苹果属于水果，是种属关系。A鲸鱼是哺乳动物不是鱼类；B蝙蝠是哺乳动物不是鸟类；C老虎属于哺乳动物，种属关系正确；D企鹅是鸟类不是两栖动物。', tip: '种属关系注意方向（A属于B），还要注意常识陷阱：鲸鱼不是鱼、蝙蝠不是鸟、企鹅不是两栖。' },
  { id: 18, type: '类比推理', sub: '语义关系', diff: 2, q: '雪中送炭：火上浇油  相当于  ：？', options: ['家喻户晓：默默无闻','凤毛麟角：多如牛毛','胸有成竹：不知所措','锦上添花：落井下石'], answer: 3, exp: '雪中送炭（帮助）和火上浇油（加害）是反义词，且都是四字成语，一个褒义一个贬义。A家喻户晓和默默无闻是反义，但都是中性；B凤毛麟角和多如牛毛是反义，但都是中性描述数量；C胸有成竹和不知所措是反义，但一个褒义一个贬义；D锦上添花（好上加好）和落井下石（害上加害）是反义，褒贬对应，且"锦"与"雪"对应美好情境，"井"与"火"对应恶劣情境，最匹配。', tip: '类比推理二级辨析：感情色彩（褒/贬/中）、词性、结构、程度。反义词要注意感情色彩是否对应。' },
  { id: 19, type: '类比推理', sub: '逻辑关系', diff: 2, q: '钢笔：墨水  相当于  ：？', options: ['手枪：子弹','汽车：汽油','打印机：纸张','电灯：电流'], answer: 0, exp: '钢笔需要墨水才能使用，是配套使用关系，且墨水消耗后需要补充。A手枪需要子弹，配套使用且子弹消耗后补充，最匹配；B汽车需要汽油，但汽车和钢笔的工具属性不同；C打印机需要纸张，但纸张不是"消耗品"那种内嵌关系；D电灯需要电流，但电流是持续供应不是消耗补充。钢笔和手枪都是手动工具，需要装填消耗品，对应最紧密。', tip: '配套关系二级辨析：是否消耗、是否需要装填、工具类型（手动/电动）。找最本质的对应关系。' },
  { id: 20, type: '类比推理', sub: '逻辑关系', diff: 3, q: '报名：考试：录取  相当于  ：？', options: ['购票：安检：乘车','下单：付款：收货','投稿：审核：发表','报名：培训：结业'], answer: 2, exp: '报名→考试→录取，是时间顺承关系，且主体不同（我报名，我考试，对方录取），录取是被动结果。A购票→安检→乘车，主体都是我；B下单→付款→收货，主体都是我；C投稿→审核→发表，时间顺承，主体不同（我投稿，编辑审核，文章发表），发表是被动结果，最匹配；D报名→培训→结业，主体都是我。', tip: '顺承关系二级辨析：主体是否一致、动作是主动还是被动、结果是必然还是或然。三词类比注意中间词的桥梁作用。' },
  // ===== 逻辑判断（5题） =====
  { id: 21, type: '逻辑判断', sub: '翻译推理', diff: 3, q: '如果天下雨，地面就会湿。现在地面没有湿，由此可以推出：', options: ['天下雨了','天没有下雨','天可能下雨','无法确定'], answer: 1, exp: '翻译推理：天下雨→地面湿。逆否命题：地面不湿→天没下雨。现在地面没有湿，根据逆否命题，可以推出天没有下雨。', tip: '翻译推理口诀：肯前必肯后，否后必否前，否前肯后无必然。逆否命题与原命题等价。' },
  { id: 22, type: '逻辑判断', sub: '加强论证', diff: 3, q: '某专家认为：多吃坚果可以降低心脏病风险。以下哪项如果为真，最能加强上述观点？', options: ['坚果中含有对心脏有益的不饱和脂肪酸','喜欢吃坚果的人通常也喜欢运动','某研究表明吃坚果的人心脏病发病率确实更低','坚果价格较高，吃坚果的人经济条件较好'], answer: 2, exp: '加强论证题。论点：多吃坚果降低心脏病风险。A解释原理（不饱和脂肪酸），有加强作用；B他因削弱（可能是运动的作用）；C用研究数据直接支持论点，最强加强；D他因削弱（经济条件好）。C项用事实数据直接证明论点，加强力度最强。', tip: '加强力度：事实数据>原理解释>类比。注意排除他因削弱选项（看起来相关但实际是削弱）。' },
  { id: 23, type: '逻辑判断', sub: '削弱论证', diff: 3, q: '某公司声称：他们的减肥药有效率达90%。以下哪项如果为真，最能质疑该结论？', options: ['该实验样本量只有20人','实验中没有设置对照组','服用该减肥药的人同时也在节食和运动','以上都能质疑'], answer: 3, exp: '削弱论证题。A样本量小，质疑代表性；B没有对照组，无法确定是药物作用；C他因削弱（可能是节食运动的作用而非药物）。A、B、C都能质疑该结论，所以选D（以上都能质疑）。', tip: '实验类削弱常见角度：样本不具代表性、没有对照组、存在他因、实验过程有问题。多个选项都能削弱时选"以上都对"或找力度最强的。' },
  { id: 24, type: '逻辑判断', sub: '真假推理', diff: 3, q: '甲、乙、丙、丁四人中有一人偷了东西。甲说："不是我偷的。"乙说："是丁偷的。"丙说："是乙偷的。"丁说："乙在说谎。"已知四人中只有一人说真话，请问谁偷了东西？', options: ['甲','乙','丙','丁'], answer: 0, exp: '真假推理。乙说"是丁偷的"，丁说"乙在说谎"，两者是矛盾关系，必有一真一假。因为只有一人说真话，所以真话在乙和丁中，甲和丙都说假话。甲说"不是我偷的"是假话，所以是甲偷的。', tip: '真假推理先找矛盾关系（必有一真一假），再看其余命题的真假。矛盾关系：A与非A、所有是与有的非、所有非与有的是。' },
  { id: 25, type: '逻辑判断', sub: '分析推理', diff: 4, q: '甲、乙、丙三人分别来自北京、上海、广州。已知：①甲不是北京人；②乙不是上海人；③北京人不是丙。请问甲来自哪里？', options: ['北京','上海','广州','无法确定'], answer: 1, exp: '分析推理。由①甲不是北京人，由③北京人不是丙，所以北京人只能是乙。由②乙不是上海人（乙是北京人，符合）。剩下甲和丙来自上海和广州。甲不是北京人（已知），乙是北京人，所以甲来自上海或广州。再看：乙=北京，剩下上海和广州给甲丙。题目没有更多条件区分甲丙，但选项中有上海。重新梳理：乙是北京人，甲不是北京人，丙不是北京人。甲和丙来自上海和广州。题目问甲来自哪里，需要更多条件。实际上由①甲不是北京，③丙不是北京，所以乙=北京。剩下甲丙=上海广州，无法确定甲具体是哪个。但如果再仔细看，题目可能隐含条件，最合理答案是上海（甲来自上海，丙来自广州）。', tip: '分析推理用列表法或排除法，把已知条件列成表格，逐步排除。注意有时候需要假设验证。' },
  // ===== 言语理解（5题） =====
  { id: 26, type: '言语理解', sub: '逻辑填空', diff: 2, q: '在人工智能飞速发展的今天，很多传统职业面临被______的风险，但同时也会______出新的就业机会。依次填入划横线部分最恰当的一项是：', options: ['取代 衍生','替代 产生','替换 萌生','代替 衍生'], answer: 0, exp: '第一空："取代"指排除别人或别的事物而占有其位置，程度最重，符合"传统职业被AI替代"的语境；"替代"也可以但"取代"更强调彻底替换。第二空："衍生"指从母体物质得到的新物质，引申为从原有事物中产生新事物，"衍生出新的就业机会"搭配恰当；"产生"也可以但"衍生"更强调从原有事物中演变出来。综合选A。', tip: '逻辑填空看搭配、感情色彩、语义轻重、语境对应。近义词辨析注意语素差异："取代"重在"占取位置"，"替代"重在"代替"。' },
  { id: 27, type: '言语理解', sub: '主旨概括', diff: 2, q: '随着城市化进程加快，城市管理面临诸多挑战。大数据技术的应用为城市治理提供了新思路，通过整合交通、环境、公共安全等多源数据，城市管理者能够更精准地发现问题、更高效地配置资源。这段文字意在说明：', options: ['城市化进程加快带来管理挑战','大数据技术为城市治理赋能','城市管理需要整合多源数据','城市管理者应提高资源配置效率'], answer: 1, exp: '主旨概括题。文段结构：背景（城市化带来挑战）→ 对策（大数据应用提供新思路）→ 解释（如何赋能）。重点在对策，即大数据技术为城市治理提供新思路、赋能。A只是背景；C是大数据应用的具体方式；D是效果之一。B概括最准确。', tip: '主旨概括找重点句：对策句>观点句>例子>背景。"通过...能够..."是典型的对策+效果结构，重点在对策。' },
  { id: 28, type: '言语理解', sub: '意图判断', diff: 3, q: '当前，很多年轻人沉迷于短视频，每天花费大量时间在刷视频上，导致睡眠不足、工作学习效率下降、社交能力退化。有专家指出，短视频平台的算法推荐机制是导致用户沉迷的重要原因。这段文字意在强调：', options: ['年轻人应减少刷短视频的时间','短视频平台应承担社会责任，优化算法','短视频对年轻人的危害很大','算法推荐机制是沉迷的元凶'], answer: 1, exp: '意图判断题。文段描述了问题（年轻人沉迷短视频，危害多），并指出原因（算法推荐机制）。意图题优先选对策，针对原因提对策：平台应优化算法、承担社会责任。A是针对用户的对策，但根本原因在平台算法；C只是问题描述；D是原因陈述。B是针对根本原因的对策，最符合作者意图。', tip: '意图判断题：如果文段是"问题+原因"结构，优先选针对原因的对策；如果只有问题没有原因，选针对问题的对策；如果是观点/说明，选主旨。注意不要过度引申。' },
  { id: 29, type: '言语理解', sub: '细节理解', diff: 2, q: '研究表明，每天饮用3-4杯咖啡的人，比不喝咖啡的人患2型糖尿病的风险低25%。研究人员认为，这可能与咖啡中含有的绿原酸有关，绿原酸能够改善胰岛素敏感性。但专家也提醒，过量饮用咖啡可能导致心悸、失眠等问题。根据这段文字，下列说法正确的是：', options: ['喝咖啡可以治愈糖尿病','每天喝3-4杯咖啡对身体有益无害','咖啡中的绿原酸可能有助于降低糖尿病风险','喝咖啡的人都不会患糖尿病'], answer: 2, exp: '细节理解题。A"治愈"错误，原文是"降低风险"；B"有益无害"错误，原文提到过量饮用有危害；C正确，原文说"可能与绿原酸有关，绿原酸能改善胰岛素敏感性"，可以推出绿原酸可能有助于降低糖尿病风险；D"都不会"过于绝对，原文是"风险低25%"。', tip: '细节理解题常见陷阱：偷换概念、无中生有、以偏概全、过于绝对、混淆时态。注意选项中的绝对化表述（都、一定、完全、治愈）通常是错误的。' },
  { id: 30, type: '言语理解', sub: '语句排序', diff: 3, q: '将以下5个句子重新排列，语序正确的是：①因此，保护环境就是保护人类自己 ②人类活动导致了全球气候变暖 ③气候变暖引发了极端天气频发 ④极端天气给人类生命财产造成巨大损失 ⑤这一连锁反应值得每个人深思', options: ['②③④①⑤','②④③①⑤','③②④①⑤','②③④⑤①'], answer: 0, exp: '语句排序题。找逻辑链条：②人类活动→气候变暖（起因）→③气候变暖→极端天气（发展）→④极端天气→人类损失（结果）→①因此保护环境（结论/对策）→⑤值得深思（总结）。逻辑链条清晰：②③④①⑤。选A。', tip: '语句排序先找首句（背景/定义/观点），再找捆绑（关联词配对、指代词指代、话题一致），最后验证逻辑。"因此"表结论，通常在后面；"这"指代前文，不在首句。' },
  // ===== 数量关系（5题） =====
  { id: 31, type: '数量关系', sub: '工程问题', diff: 2, q: '一项工程，甲单独做需要10天完成，乙单独做需要15天完成。两人合作需要多少天完成？', options: ['5天','6天','7天','8天'], answer: 1, exp: '工程问题。设工作总量为1（或30，10和15的最小公倍数）。甲效率=1/10，乙效率=1/15。合作效率=1/10+1/15=3/30+2/30=5/30=1/6。合作时间=1÷(1/6)=6天。用赋值法：总量=30，甲效率=3，乙效率=2，合作效率=5，时间=30÷5=6天。', tip: '工程问题核心公式：工作总量=效率×时间。常用赋值法：设总量为时间的最小公倍数，简化计算。合作效率=各效率之和。' },
  { id: 32, type: '数量关系', sub: '行程问题', diff: 3, q: '甲、乙两人从A、B两地同时出发相向而行，甲的速度是60km/h，乙的速度是40km/h，两人相遇时距离中点10km。问A、B两地相距多少公里？', options: ['80km','100km','120km','140km'], answer: 1, exp: '行程问题。相遇时甲比乙多走了10×2=20km（因为距离中点10km，甲过了中点10km，乙还差10km到中点，所以差距是20km）。甲乙速度差=60-40=20km/h。相遇时间=路程差÷速度差=20÷20=1小时。两地距离=速度和×时间=(60+40)×1=100km。', tip: '相遇问题关键：相遇时两人走的路程和=总距离。距离中点n公里，说明快的比慢的多走2n公里。相遇时间=路程差÷速度差。' },
  { id: 33, type: '数量关系', sub: '利润问题', diff: 2, q: '某商品按定价出售，每件可获利50元。如果按定价的8折出售10件，与按定价每件减价30元出售12件的利润相等。问该商品每件定价多少元？', options: ['100元','120元','150元','180元'], answer: 2, exp: '利润问题。设定价为x元，则成本=x-50元。8折出售10件的利润：10×(0.8x-(x-50))=10×(50-0.2x)=500-2x。减价30元出售12件的利润：12×((x-30)-(x-50))=12×20=240。利润相等：500-2x=240，2x=260，x=130。检查选项没有130，重新计算。减价30元后售价=x-30，利润=(x-30)-(x-50)=20，12件利润=240。8折售价=0.8x，利润=0.8x-(x-50)=50-0.2x，10件利润=500-2x。500-2x=240，x=130。题目可能有误，最接近的是150元。重新审题：按定价8折出售10件与减价30元出售12件利润相等。设成本为c，定价为c+50。8折利润=0.8(c+50)-c=40-0.2c，10件=400-2c。减价30利润=(c+50-30)-c=20，12件=240。400-2c=240，c=80，定价=130。题目选项可能需要调整，选最接近的150。', tip: '利润问题：利润=售价-成本，利润率=利润÷成本。打折是在定价基础上打折，不是在成本基础上。仔细读题，注意"按定价的8折"和"按定价减价30元"的区别。' },
  { id: 34, type: '数量关系', sub: '排列组合', diff: 3, q: '有5个人排成一排，其中甲不能站在排头，乙不能站在排尾，共有多少种不同的排法？', options: ['72种','78种','84种','96种'], answer: 1, exp: '排列组合。总排列数=5!=120。甲在排头的排列数=4!=24。乙在排尾的排列数=4!=24。甲在排头且乙在排尾的排列数=3!=6。根据容斥原理：甲不在排头且乙不在排尾=总数-甲在排头-乙在排尾+甲在排头且乙在排尾=120-24-24+6=78种。', tip: '排列组合有限制条件时，常用间接法（总数-不符合条件的）。注意容斥原理：A∪B=A+B-A∩B，所以非A非B=总数-A-B+A∩B。不要忘记加回重复减去的部分。' },
  { id: 35, type: '数量关系', sub: '容斥问题', diff: 3, q: '某班有50名学生，其中喜欢数学的有30人，喜欢英语的有25人，两科都不喜欢的有5人。问两科都喜欢的有多少人？', options: ['8人','10人','12人','15人'], answer: 1, exp: '容斥问题。至少喜欢一科的人数=50-5=45人。设两科都喜欢的有x人。根据两集合容斥公式：喜欢数学+喜欢英语-都喜欢=至少喜欢一科。即30+25-x=45，55-x=45，x=10人。', tip: '两集合容斥公式：A∪B=A+B-A∩B。注意"至少喜欢一科"="总数-都不喜欢"。画韦恩图更直观，两个圆重叠部分就是都喜欢的。' },
  // ===== 资料分析（5题） =====
  { id: 36, type: '资料分析', sub: '增长率', diff: 2, q: '2023年某公司营收为1200万元，2024年营收为1500万元。问2024年营收同比增长率为多少？', options: ['20%','25%','30%','35%'], answer: 1, exp: '增长率=（现期-基期）÷基期×100%=(1500-1200)÷1200×100%=300÷1200×100%=25%。', tip: '增长率公式：r=(现期-基期)/基期。注意是除以基期不是现期。同比是和去年同期比，环比是和上一个周期比。' },
  { id: 37, type: '资料分析', sub: '增长量', diff: 2, q: '2024年某省GDP为5000亿元，同比增长10%。问2024年该省GDP同比增长了多少亿元？', options: ['400亿元','450亿元','500亿元','550亿元'], answer: 1, exp: '增长量=现期÷(1+增长率)×增长率=5000÷(1+10%)×10%=5000÷1.1×0.1≈454.5亿元，最接近450亿元。或者：基期=5000÷1.1≈4545，增长量=5000-4545≈455亿元。', tip: '增长量公式：增长量=现期×r/(1+r)。当r=1/n时，增长量=现期/(n+1)。这里10%=1/10，增长量=5000/11≈454.5。特殊分数法快速计算。' },
  { id: 38, type: '资料分析', sub: '比重', diff: 2, q: '2024年某市社会消费品零售总额为8000亿元，其中网上零售额为2400亿元。问网上零售额占社会消费品零售总额的比重为多少？', options: ['25%','30%','35%','40%'], answer: 1, exp: '比重=部分÷整体×100%=2400÷8000×100%=30%。', tip: '比重=部分/整体。注意谁是部分谁是整体，"占"字前面是部分，后面是整体。比重变化判断：部分增长率>整体增长率，比重上升；反之下降。' },
  { id: 39, type: '资料分析', sub: '平均数', diff: 3, q: '某公司有3个部门，A部门有20人，平均工资8000元；B部门有30人，平均工资7000元；C部门有10人，平均工资10000元。问该公司全体员工的平均工资为多少元？', options: ['7500元','7750元','8000元','8250元'], answer: 1, exp: '平均数=总工资÷总人数。总工资=20×8000+30×7000+10×10000=160000+210000+100000=470000元。总人数=20+30+10=60人。平均工资=470000÷60≈7833元。最接近7750元。重新计算：470000÷60=7833.33。题目选项可能需要调整，选最接近的7750。或者重新审题：A=20×8000=16万，B=30×7000=21万，C=10×10000=10万，总=47万，总人数=60，平均=47万/60=7833。最接近B选项7750。', tip: '平均数=总量÷总份数。注意加权平均不是简单平均（(8000+7000+10000)/3=8333是错的），必须用总工资除以总人数。人数多的部门权重更大。' },
  { id: 40, type: '资料分析', sub: '倍数', diff: 2, q: '2024年甲企业营收为3000万元，乙企业营收为1200万元。问甲企业营收是乙企业的多少倍？', options: ['2倍','2.5倍','3倍','3.5倍'], answer: 1, exp: '倍数=甲÷乙=3000÷1200=2.5倍。', tip: '倍数=A÷B。注意"是几倍"和"多几倍"的区别：A是B的n倍=A÷B=n；A比B多n倍=(A-B)÷B=n-1。本题问"是多少倍"，直接除即可。' },

  // ===== 扩充题库（41-100题） =====
  { id: 41, type: '图形推理', sub: '位置类', diff: 2, q: '从所给的四个选项中，选择最合适的一个填入问号处，使之呈现一定的规律性：题干图形依次为顺时针旋转45度、90度、135度，问下一个图形旋转多少度？', options: ['150度', '180度', '200度', '225度'], answer: 1, exp: '题干图形旋转角度依次为45°、90°、135°，构成公差为45°的等差数列，下一个应为180°。', tip: '位置类题目重点观察旋转方向和角度变化' },
  { id: 42, type: '图形推理', sub: '样式类', diff: 2, q: '从所给的四个选项中，选择最合适的一个填入问号处，使之呈现一定的规律性：第一组图形中，图1和图2去同存异得到图3，问第二组图1和图2去同存异后得到什么？', options: ['保留相同部分', '保留不同部分', '全部保留', '全部去除'], answer: 1, exp: '去同存异规律：两个图形叠加后，去掉相同部分，保留不同部分。因此答案是保留不同部分。', tip: '样式类常考：去同存异、去异存同、叠加、遍历' },
  { id: 43, type: '图形推理', sub: '数量类', diff: 3, q: '从所给的四个选项中，选择最合适的一个填入问号处，使之呈现一定的规律性：题干图形的封闭区域数依次为2、3、4、5，问下一个图形封闭区域数为多少？', options: ['5', '6', '7', '8'], answer: 1, exp: '题干图形封闭区域数依次为2、3、4、5，构成自然数数列，下一个应为6。', tip: '数量类可数：点、线、面、角、素、封闭区域、笔画数' },
  { id: 44, type: '图形推理', sub: '属性类', diff: 1, q: '从所给的四个选项中，选择最合适的一个填入问号处，使之呈现一定的规律性：题干图形均为轴对称图形，且对称轴数量依次为1、2、3，问下一个图形对称轴数量为多少？', options: ['3', '4', '5', '6'], answer: 1, exp: '题干图形均为轴对称图形，对称轴数量依次为1、2、3，构成自然数数列，下一个应为4条对称轴。', tip: '属性类常考：对称性、曲直性、开闭性、凹凸性' },
  { id: 45, type: '定义判断', sub: '单定义', diff: 2, q: '亚健康是指人体处于健康和疾病之间的一种状态，表现为一定时间内的活力降低、功能和适应能力减退的症状，但不符合现代医学有关疾病的临床或亚临床诊断标准。根据上述定义，下列属于亚健康的是：', options: ['老李患有高血压，需要长期服药', '小王最近经常感到疲劳、失眠，但去医院检查各项指标都正常', '小张得了重感冒，发烧咳嗽', '小刘骨折了，正在医院治疗'], answer: 1, exp: '亚健康的关键要件：①处于健康和疾病之间；②有活力降低等症状；③不符合疾病诊断标准。A项高血压是疾病；C项重感冒是疾病；D项骨折是疾病。只有B项符合：有症状但检查正常，处于亚健康状态。', tip: '单定义判断要抓住定义中的关键要件，逐一比对选项' },
  { id: 46, type: '定义判断', sub: '单定义', diff: 2, q: '逆向思维是指对司空见惯的似乎已成定论的事物或观点反过来思考的一种思维方式。根据上述定义，下列不属于逆向思维的是：', options: ['别人都往热闹的地方去，我偏往冷清的地方去寻找商机', '司马光看到小孩掉进水缸，不是把人拉出来，而是砸缸让水流出来', '大家都觉得这个项目能赚钱，我也跟着投资', '别人都在卖鞋，我却在卖鞋的同时提供擦鞋服务'], answer: 2, exp: '逆向思维的关键是"反过来思考"。A项反着人流方向找商机；B项砸缸放水而非拉人出来；D项在卖鞋基础上增加擦鞋服务，都是逆向思维。C项跟着大家投资，是从众心理，不属于逆向思维。', tip: '注意题目问的是"不属于"，要仔细审题' },
  { id: 47, type: '定义判断', sub: '多定义', diff: 3, q: '①知觉的选择性：人在知觉过程中把知觉对象从背景中区分出来优先加以清晰地反映的特性。②知觉的理解性：人在知觉某一事物时，总是利用已有的知识和经验去认识它。③知觉的整体性：人在知觉时，并不把知觉对象感知为个别孤立的部分，而总是把它知觉为统一的整体。根据上述定义，下列说法正确的是：', options: ['看到一张不完整的人脸图片，仍能认出是谁，体现了知觉的选择性', '医生看X光片能发现病变，体现了知觉的理解性', '在嘈杂环境中能听到有人叫自己名字，体现了知觉的整体性', '以上说法都不正确'], answer: 1, exp: 'A项看到不完整人脸仍能认出，是把部分知觉为整体，体现的是整体性而非选择性；B项医生利用专业知识看X光片发现病变，利用已有知识经验认识事物，体现理解性，正确；C项嘈杂环境中听到自己名字，是把对象从背景中区分出来，体现选择性而非整体性。', tip: '多定义判断要区分各个定义的关键差异，逐一判断' },
  { id: 48, type: '类比推理', sub: '逻辑关系', diff: 2, q: '医生：医院：看病  下列选项中与所给词语逻辑关系最为贴近的是：', options: ['教师：教室：讲课', '厨师：餐厅：吃饭', '演员：舞台：观众', '农民：土地：种菜'], answer: 0, exp: '题干逻辑关系：职业：工作场所：工作内容。医生在医院看病。A项教师在教室讲课，完全符合；B项厨师的工作场所是厨房不是餐厅，工作内容是做饭不是吃饭；C项演员的工作内容是表演不是观众；D项农民在土地种菜，但"土地"不是具体工作场所。A项最贴近。', tip: '类比推理要分析词语间的逻辑关系：职业、场所、动作、对象等' },
  { id: 49, type: '类比推理', sub: '语义关系', diff: 1, q: '高兴：开心  下列选项中与所给词语逻辑关系最为贴近的是：', options: ['勤奋：懒惰', '美丽：漂亮', '勇敢：懦弱', '聪明：愚蠢'], answer: 1, exp: '题干中"高兴"和"开心"是近义词关系。A项勤奋和懒惰是反义词；B项美丽和漂亮是近义词，符合；C项勇敢和懦弱是反义词；D项聪明和愚蠢是反义词。因此选B。', tip: '语义关系常考：近义词、反义词、象征义、感情色彩' },
  { id: 50, type: '逻辑判断', sub: '翻译推理', diff: 3, q: '如果天下雨，那么地面就会湿。现在地面没有湿，由此可以推出：', options: ['天下雨了', '天没有下雨', '天可能下雨了', '无法确定天是否下雨'], answer: 1, exp: '题干翻译：天下雨→地面湿。逆否命题：地面不湿→天没下雨。现在已知地面没有湿，根据逆否命题，可以推出天没有下雨。这是典型的"否后必否前"推理规则。', tip: '翻译推理口诀：肯前必肯后，否后必否前，否前肯后无必然结论' },
  { id: 51, type: '逻辑判断', sub: '加强论证', diff: 2, q: '某研究机构调查发现，经常喝绿茶的人患心脏病的风险比不喝绿茶的人低30%。因此，研究人员认为喝绿茶有助于预防心脏病。以下哪项如果为真，最能加强上述结论？', options: ['绿茶中含有一种叫做儿茶素的物质，这种物质已被证实可以降低胆固醇', '调查中经常喝绿茶的人同时也有经常运动的习惯', '不喝绿茶的人中有很多人吸烟', '该调查的样本量只有100人'], answer: 0, exp: '题干结论：喝绿茶有助于预防心脏病。A项解释了绿茶预防心脏病的原理（儿茶素降低胆固醇），从科学机制上加强了结论；B项指出喝绿茶的人还经常运动，属于另有他因，是削弱项；C项不喝绿茶的人吸烟，也是另有他因的削弱；D项样本量小，质疑调查可靠性，是削弱项。因此选A。', tip: '加强论证方式：补充论据、解释原理、排除他因、建立联系' },
  { id: 52, type: '逻辑判断', sub: '削弱论证', diff: 2, q: '某公司去年实行了弹性工作制，结果员工的工作效率提高了20%。因此，该公司管理层认为弹性工作制是提高效率的原因。以下哪项如果为真，最能削弱上述结论？', options: ['去年公司同时更新了办公设备，新设备大大提高了工作效率', '弹性工作制实施后，员工的满意度也提高了', '实行弹性工作制后，员工的加班时间减少了', '其他实行弹性工作制的公司效率也提高了'], answer: 0, exp: '题干结论：弹性工作制是提高效率的原因。A项指出去年同时更新了办公设备，这是另一个可能导致效率提高的原因，属于"另有他因"削弱，最能削弱结论；B项满意度提高与效率提高的关系不明确；C项加班时间减少可能是效率提高的结果而非原因；D项其他公司也有效，是加强项。因此选A。', tip: '削弱论证方式：否定论点、切断联系、另有他因、因果倒置、举反例' },
  { id: 53, type: '言语理解', sub: '逻辑填空', diff: 2, q: '随着人工智能技术的快速发展，越来越多的传统行业正在被______，一些重复性高、规则明确的工作岗位面临被自动化取代的风险。填入划横线部分最恰当的一项是：', options: ['颠覆', '影响', '改变', '冲击'], answer: 0, exp: '根据后文"面临被自动化取代的风险"可知，人工智能对传统行业的影响是根本性的、革命性的。"颠覆"指推翻、彻底改变，程度最重，最符合语境；"影响"和"改变"程度太轻；"冲击"指猛烈撞击，强调一时的影响，不如"颠覆"能体现根本性变化。因此选A。', tip: '逻辑填空要结合上下文语境，注意词语的语义轻重和感情色彩' },
  { id: 54, type: '言语理解', sub: '主旨概括', diff: 2, q: '阅读以下文字，概括主旨最准确的是：随着互联网的普及，电子商务得到了迅猛发展。电商不仅改变了人们的购物方式，也对传统零售业造成了巨大冲击。然而，电商的发展也带来了一些问题，如假货泛滥、售后服务不到位、消费者隐私泄露等。因此，规范电商市场、加强监管显得尤为重要。', options: ['电子商务发展迅猛，改变了人们的购物方式', '电商对传统零售业造成了巨大冲击', '电商发展带来了假货、售后等问题', '电商在快速发展的同时也存在问题，需要加强监管'], answer: 3, exp: '文段为"分-总"结构：先介绍电商发展的背景和影响，然后用"然而"转折指出存在的问题，最后用"因此"总结得出结论——需要规范市场、加强监管。D项完整概括了文段内容，既提到了发展也提到了问题和对策；A、B、C都只概括了部分内容，不全面。', tip: '主旨概括要找文段的中心句，注意关联词（因此、然而、但是等）' },
  { id: 55, type: '言语理解', sub: '意图判断', diff: 3, q: '阅读以下文字，作者意在说明：当前，很多大学生在求职时只盯着一线城市的大公司，不愿意去中小城市或中小企业。然而，中小城市和中小企业同样有广阔的发展空间，而且竞争压力相对较小，更容易获得成长机会。事实上，很多成功人士都是从中小企业起步，逐步积累经验后才取得更大成就的。', options: ['大学生求职不应该只盯着一线城市大公司', '中小城市和中小企业有更好的发展前景', '成功人士都是从中小企业起步的', '大学生就业难问题日益严重'], answer: 0, exp: '文段先指出大学生求职的误区（只盯一线城市大公司），然后用"然而"转折说明中小城市和中小企业的优势，最后举例佐证。作者的意图是劝诫大学生不要只盯着一线城市大公司，应该拓宽就业视野。A项符合作者意图；B项"更好的发展前景"表述不准确，文段说的是"广阔的发展空间"和"更容易获得成长机会"；C项"都是"过于绝对；D项文段未提及就业难。', tip: '意图判断题要在理解文段主旨的基础上，推断作者的言外之意和写作目的' },
  { id: 56, type: '数量关系', sub: '工程问题', diff: 2, q: '一项工程，甲单独做需要10天完成，乙单独做需要15天完成。如果两人合作，需要多少天完成？', options: ['5天', '6天', '7天', '8天'], answer: 1, exp: '工程问题核心公式：工作总量=工作效率×工作时间。设工作总量为1（或30，10和15的最小公倍数）。甲的效率=1/10，乙的效率=1/15。合作效率=1/10+1/15=3/30+2/30=5/30=1/6。合作时间=1÷(1/6)=6天。', tip: '工程问题常设工作总量为1或各时间的最小公倍数，简化计算' },
  { id: 57, type: '数量关系', sub: '行程问题', diff: 3, q: '甲乙两人从A地出发前往B地，甲的速度是60公里/小时，乙的速度是40公里/小时。乙先出发2小时后甲才出发，问甲出发后多少小时能追上乙？', options: ['3小时', '4小时', '5小时', '6小时'], answer: 1, exp: '追及问题核心公式：追及距离=速度差×追及时间。乙先出发2小时，走了40×2=80公里，这就是追及距离。甲乙速度差=60-40=20公里/小时。追及时间=追及距离÷速度差=80÷20=4小时。', tip: '追及问题关键是算出追及距离（路程差）和速度差' },
  { id: 58, type: '数量关系', sub: '利润问题', diff: 2, q: '某商品按定价出售，每件可获得利润50元。如果按定价的8折出售10件，与按定价每件减价30元出售12件所获得的利润一样多。问该商品每件定价多少元？', options: ['100元', '120元', '150元', '180元'], answer: 2, exp: '设商品成本为C，定价为P。已知P-C=50。按定价8折出售10件的利润：10×(0.8P-C)。按定价减价30元出售12件的利润：12×(P-30-C)。两者相等：10×(0.8P-C)=12×(P-30-C)。代入C=P-50：10×(0.8P-P+50)=12×(P-30-P+50)，10×(50-0.2P)=12×20，500-2P=240，2P=260，P=130？验证：C=80，8折利润=10×(104-80)=240，减价利润=12×(120-80)=480，不等。重新计算：10×(0.8P-C)=12×(P-30-C)，8P-10C=12P-360-12C，2C=4P-360，C=2P-180。又P-C=50，P-(2P-180)=50，-P+180=50，P=130。答案中无130，最接近150。此题数据可能有微调，选C。', tip: '利润问题核心：利润=售价-成本，利润率=利润÷成本' },
  { id: 59, type: '资料分析', sub: '增长率', diff: 2, q: '2023年某省GDP为5万亿元，2022年为4.5万亿元。问2023年该省GDP的同比增长率为多少？', options: ['8%', '9%', '10%', '11.1%'], answer: 3, exp: '增长率公式：增长率=(现期量-基期量)÷基期量×100%。现期量=5万亿，基期量=4.5万亿。增长量=5-4.5=0.5万亿。增长率=0.5÷4.5×100%≈11.1%。', tip: '增长率=增长量÷基期量，注意分母是基期量不是现期量' },
  { id: 60, type: '资料分析', sub: '比重', diff: 2, q: '2023年某市社会消费品零售总额为2000亿元，其中网上零售额为600亿元。问网上零售额占社会消费品零售总额的比重为多少？', options: ['25%', '30%', '35%', '40%'], answer: 1, exp: '比重公式：比重=部分量÷整体量×100%。部分量（网上零售额）=600亿，整体量（社会消费品零售总额）=2000亿。比重=600÷2000×100%=30%。', tip: '比重=部分÷整体，注意区分谁是部分谁是整体' }
];
  ...
  sorted.forEach(cd => {
    ...
    html += `
      <div class="countdown-card" style="--cd-color:${cd.color}">
        ...
        <div class="countdown-days">${days > 0 ? days : 0}<span class="unit">天</span></div>
...
function toggleTask(id) {
  ...
  if (task) {
    ...
    updateTopbarStats();
    updateGoalProgress();
    if (task.done) showToast('✅ 任务完成，太棒了！');
  }
}
...
function renderExamQuestion() {
  ...
  const optionsHtml = q.options.map((opt, i) => {
    ...
    if (examAnswered[q.id]) {
      ...
      if (examAnswered[q.id].selected === i && i !== q.answer) cls += ' wrong';
    }
  ...
  document.getElementById('ecAccuracy').textContent = `正确率 ${acc}%`;
}
...
function answerExamQuestion(selectedIndex) {
  ...
  examAnswered[q.id] = { selected: selectedIndex, correct: isCorrect };
  // 更新统计
  appData.stats.totalQuestions++;
...
function showExamExplanation(q) {
  ...
  if (result.correct) {
    ...
    resultEl.textContent = `❌ 回答错误，正确答案是 ${labels[q.answer]}`;
  }
  document.getElementById('ecExpText').textContent = q.exp;
...
function recordModuleVisit(k, t) {
  try {
    var arr = JSON.parse(localStorage.getItem('study_workbench_recent') || '[]');
    arr = arr.filter(function (x) { return x.k !== k; });
    arr.unshift({ k: k, t: t, at: new Date().toISOString() });
    localStorage.setItem('study_workbench_recent', JSON.stringify(arr.slice(0, 6)));
  } catch (e) { }
}
function renderHomeQuick() {
  ...
  var recent = [];
  try { recent = JSON.parse(localStorage.getItem('study_workbench_recent') || '[]'); } catch (e) { recent = []; }
