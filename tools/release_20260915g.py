# -*- coding: utf-8 -*-
"""20260915g：线上直连复检 -> 代理探测 -> 推送 GitHub"""
import os, re, io, socket, subprocess, urllib.request, urllib.parse

ROOT = r'D:\下载的文件\学习工作台'
OUT = os.path.join(ROOT, 'tools', 'qa', '_release_g_out.txt')
...
CHECKS = [
    ('更多.html',       ['nav-section">常用', '学习动态']),
    ('AI模拟面试.html', ['查看示范回答']),
    ('PPT训练.html',    ['20260915g']),
    ('私聊.html',       ['chat-local.js?v=20260915g']),
    ('四级备考.html',   ['voiceplayer.js?v=20260915g']),
    ('学途.html',       ['voiceplayer.js?v=20260915g']),
    ('blog_wechat.html', ['app.js?v=20260915f', 'api.js?v=20260915f']),
    ('工具.html',       ['app.js?v=']),
    ('assets/voiceplayer.js', ['SCENE_GROUPS']),
    ('assets/chat-local.js',  ['imShowMsgMenu']),
]
L.append('=== 1. 线上直连复检 ===')
