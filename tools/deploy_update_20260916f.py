...
files = ['assets/ai-config.js', 'assets/ai-presets.js', 'assets/ai-service.js',
         'assets/ai-page.js', 'assets/app.js', 'assets/api.js'] + htmls
...
for must in ['web/AI.html', 'web/工具.html', 'web/学习工作台.html', 'web/assets/ai-service.js']:
