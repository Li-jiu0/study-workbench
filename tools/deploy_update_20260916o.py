# -*- coding: utf-8 -*-
"""20260916O 热修：企业定向库 hero 分类标签删除"""
import os, io, sys, glob, tarfile, subprocess, re

ROOT = r'D:\下载的文件\学习工作台'
STAMP = '20260916O'
PREV_STAMP = '20260916N'
...
OUT = r'C:\Users\ATM\_dep_o_out.txt'
LOG = []
...
DEL = [
    ...
    ('web/assets/company-lib.js', b'cl-hero-tags'),
    ('web/assets/company-lib.js', b'cl-tag'),
    ('web/企业定向库.html', 'clTabs'.encode('utf-8')),
    ('web/企业定向库.html', 'cl-hero-tags'.encode('utf-8')),
    ('web/企业定向库.html', 'cl-tag'.encode('utf-8')),
]
del_bad = []
with tarfile.open(TAR) as t:
    for path, tok in DEL:
...
remote = (
    ...
    "echo \"  company-lib.js cl-hero-tags: $(grep -c cl-hero-tags assets/company-lib.js)\"; "
    "echo \"  company-lib.js cl-tag: $(grep -c cl-tag assets/company-lib.js)\"; "
    "echo \"  企业定向库.html cl-hero-tags: $(grep -c cl-hero-tags 企业定向库.html)\"; "
    "echo \"  企业定向库.html cl-tag: $(grep -c cl-tag 企业定向库.html)\"; "
