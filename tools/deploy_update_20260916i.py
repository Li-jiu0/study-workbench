...
files = ['assets/app.js', 'assets/ai-config.js', 'assets/ai-service.js',
         'assets/ai-page.js', 'assets/ai-presets.js']
...
if not host or not pwd:
    ...
    if not m:
        LOG.append('NO CRED')
        io.open(r'C:\Users\ATM\_dep_i_out.txt', 'w', encoding='utf-8').write('\n'.join(LOG))
        sys.exit(2)
