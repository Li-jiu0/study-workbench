...
files = ['assets/xt-polyfill.js', 'assets/xt-settings.js']
...
for must in ['web/assets/xt-polyfill.js', 'web/assets/xt-settings.js', 'web/AI.html']:
...
if not host or not pwd:
    ...
    if not m:
        LOG.append('NO CRED')
        io.open(r'C:\Users\ATM\_dep_j_out.txt', 'w', encoding='utf-8').write('\n'.join(LOG))
        sys.exit(2)
...
remote = (
    ...
    "echo '--- polyfill/settings 校验 ---'; "
    "grep -c 'Object.values' web/assets/xt-polyfill.js; "
    "grep -c 'loadAllSettings' web/assets/xt-settings.js; "
    "grep -c 'xt-polyfill' web/AI.html; "
    "grep -c 'xt-settings' web/设置.html"
