...
n1 = text.count('AQ.Ab8RN6')
n2 = text.count('sk-or-v1-65bfdfbf')
log('脱敏目标出现次数: AQ.Ab8RN6×%d, sk-or-v1-65bfdfbf×%d' % (n1, n2))

# ---------- 1) 脱敏 ----------
text2 = text.replace('AQ.***REDACTED-已泄露作废-需换新KEY***', 'AQ.REDACTED-GEMINI-KEY')
text2 = text2.replace('***REMOVED-BY-R2C***', 'sk-or-v1-REDACTED-OPENROUTER-KEY')
assert 'AQ.Ab8RN6' not in text2 and 'sk-or-v1-65bfdfbf' not in text2, '脱敏后仍有真实 Key'
