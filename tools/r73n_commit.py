...
for f in STAGE:
    ...
    for pat in [b'<REDACTED-GEMINI-旧KEY前缀>', b'<REDACTED-OPENROUTER-旧KEY前缀>', b'<REDACTED-ARK-旧KEY前缀>', b'<REDACTED-ZHIPU-旧KEY前缀>5685', b'bce-v3/<REDACTED-ALTAK>', b'sk-<REDACTED>']:
        if pat in raw:
